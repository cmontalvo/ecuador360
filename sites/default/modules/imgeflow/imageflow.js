...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		reflectPath:        '/sites/default/modules/imageflow/',             /* Path to the reflect_.php script */
		...
		for(var index = 0; index < max; index++)
		{
			...
			if (node && node.nodeType == 1 && node.nodeName == 'IMG')
			{
				...
				if(my.reflections === true)
				{
					...
					src = my.reflectPath+'reflect'+version+'.php?func=reflectme&img='+src+my.reflectionGET;
